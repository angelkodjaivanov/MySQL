...
-- task 2 One to many realationship
...
(103, 'Silvia', 106), (104, 'Ted', 105), (105, 'Mark', 101), (106, 'Greta', 101);
...
-- task 9
USE geography;
SELECT m.mountain_range, p.peak_name, p.elevation FROM peaks AS p JOIN mountains AS m ON p.mountain_id = m.id
